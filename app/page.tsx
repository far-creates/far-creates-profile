  ...
  return (
    <div className="font-primary text-primary">
      <main className="h-screen w-6xl flex items-center justify-center">
        <div className="w-1/2 h-68  px-7 border-r-2 border-primary  text-2xl text-right animate-slide-right">
          {" "}
          What looks simple
          <br /> took a thousand invisible decisions
        </div>
        <div className="w-1/2 px-7 h-72 flex-col content-end animate-slide-left">
